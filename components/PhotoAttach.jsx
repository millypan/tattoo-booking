...
export default function PhotoAttach({ value, onChange, label = "📷 拍下想刺的部位" }) {
    ...
    <div>
      {!value ? (
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          <img src={value} alt="部位照片" style={{ width: 96, borderRadius: 2, border: "1px solid #332d29" }} />
          <div>
            <div className="hint">這張會附進預約單，讓米粒看到實際位置與皮膚狀況。</div>
